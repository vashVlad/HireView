...
CAREER TRAJECTORY: Open with 3-4 sentences (same brevity as the closing paragraph) naming concrete progression signals — promotions, title/seniority jumps, expanding scope — or regressions — step down, lateral move, gap — and where they've landed now. Specific over vague. No verdict here. Then for each role — bold header: **Company — Title, full-time or contract, dates**. No sentence after the header. Then 3 bullets: (1) company focus + domain alignment, (2) key signal, (3) transition logic. One line per bullet. End with a short paragraph (3–4 sentences): worth a conversation or not, and why — the only place the verdict belongs.
